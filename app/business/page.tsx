...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "不動産会社・管理会社・賃貸オーナー・旅館・ホテル・寺院・神社・店舗・法人施設向けの畳工事・内装工事・原状回復。複数物件・継続案件・写真付き報告・見積もり対応。法人窓口を一本化します。",
  path: "/business",
});
  ...
  return (
    <>
      ...
      <section className="bg-sumi py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-white/60 max-w-2xl leading-relaxed">
            ...
            畳・内装・原状回復を、複数物件・継続案件・写真付き報告・見積もり対応で一括サポートします。
          </p>
        </div>
      </section>
      ...
      <section className="py-14 bg-shiro">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 text-sm text-sumi/80 leading-relaxed">
          ...
          <p>
            ...
            継続的なお取引では担当者制でのご連絡・請求書払いについてもご相談いただけます。
          </p>
        </div>
      </section>
      ...
      <CTASection
        ...
        subtitle="複数物件・継続案件のご相談も歓迎です。まずはお気軽にお問い合わせください。"
      />
    </>
  );
}

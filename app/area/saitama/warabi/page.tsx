...
export const metadata: Metadata = buildMetadata({
  title: "蕨市の畳張替え・表替え・新調｜高密度住宅地対応｜埼玉畳店",
  description:
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-sumi/80 leading-relaxed">
              ...
              <p>
                住まいの特徴は、戸建て・アパート・マンションが高い密度で密集していることです。特に、限られた敷地を生かした狭小地の3階建て住宅や、接道の狭い路地の奥に建つお宅が多く見られます。こうした立地では大きな車を横付けできないこともありますが、埼玉畳店では畳をお預かりして工場で仕上げる持ち帰り施工を基本としているため、駐車スペースのないお宅や路地の奥の住宅でも問題なく対応できます。
              </p>
              <p>
                建物が密集し換気がしにくい高密度住宅地では、畳のカビ・ダニが発生しやすい傾向があります。埼玉畳店では、伝統的ない草表に加え、防カビ・防湿性に優れた和紙畳・樹脂畳をご用意し、住まいの環境に合わせてご提案しています。4畳半や6畳のコンパクトな和室でも、一枚から丁寧に対応いたします。
              </p>
              <p>

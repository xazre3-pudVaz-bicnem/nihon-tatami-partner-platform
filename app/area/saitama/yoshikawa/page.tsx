...
const { pref, city } = getCity("saitama", "yoshikawa") || { pref: null, city: null };

const FAQ_ITEMS = [
  {
    q: "吉川市内のどのエリアまで対応していますか？",
    a: "吉川市全域に対応しています。吉川駅・吉川美南駅周辺の住宅地から、中央・平沼・保・旭など市内全域でご依頼をお受けしています。",
    category: "general" as const,
  },
  {
    q: "吉川美南の新しい住宅の和室にも対応できますか？",
    a: "はい。吉川美南駅周辺は近年開発が進み、新築戸建てや分譲マンションが急増しているエリアです。フローリングに合わせた薄型畳や縁なし畳の表替え・新調に対応しています。",
    category: "general" as const,
  },
  {
    q: "共働き世帯でも依頼しやすい方法はありますか？",
    a: "はい。吉川市は都心へ通勤する子育て・共働き世帯が多いエリアです。畳を一度お預かりして工房で仕上げる方法や、土日・夕方の訪問にも対応し、ご都合に合わせて調整します。",
    category: "general" as const,
  },
  {
    q: "湿気の多い低地ですが畳のカビ対策はできますか？",
    a: "はい。吉川市は中川・江戸川に挟まれた低地で、湿気がこもりやすいエリアです。防カビ・防ダニ加工の畳表や、調湿性・耐水性に優れた和紙畳・樹脂畳をご提案できます。",
  ...
  },
  {
    ...
    a: "はい。傷や汚れに強く、ダニ・カビが発生しにくい和紙畳・樹脂畳がおすすめです。お手入れが簡単で、子育て世帯の多い吉川美南エリアでも人気です。",
    category: "material" as const,
  },
  {
    q: "襖や障子もまとめて頼めますか？",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "吉川市", item: `${SITE_URL}/area/saitama/yoshikawa` },
  ],
};
...
const webPageSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  "@id": `${SITE_URL}/area/saitama/yoshikawa#webpage`,
  name: "吉川市の畳張替え・表替え・新調",
  description: "吉川市全域で畳の張替え・表替え・新調に対応。なまずの里として知られ、吉川美南の新興住宅地が広がる東部エリア。戸建て・分譲マンション・賃貸に実績豊富。現地確認・見積もり無料。",
  url: `${SITE_URL}/area/saitama/yoshikawa`,
  inLanguage: "ja",
...
const localBusinessSchema = {
  ...
  telephone: SITE_TEL,
  email: SITE_EMAIL,
  description: "吉川市全域対応の畳張替え・表替え・新調・原状回復専門業者。新興住宅地の戸建て・分譲マンションにも対応。",
...
export default function YoshikawaPage() {
  return (
    <>
      ...
      <section className="bg-sumi py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-white/60 max-w-2xl leading-relaxed mb-6">
            低地で湿気がこもりやすい地域特性を踏まえ、防カビ・調湿に配慮した素材選びをご提案。子育て世帯に人気の傷・汚れに強い畳も丁寧にご案内します。
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-sumi/80 leading-relaxed">
              <p>
                吉川市は埼玉県の東部、中川と江戸川に挟まれた水辺のまちです。古くから川魚料理の文化が根付き、「なまずの里」として親しまれてきました。JR武蔵野線の吉川駅・吉川美南駅を中心に、都心への通勤圏として発展しています。
              </p>
              <p>
                特に吉川美南駅周辺は近年開発が急速に進み、大型商業施設とともに新築戸建てや分譲マンションが立ち並ぶ新興住宅地となっています。子育て世帯や共働き世帯が多く暮らし、フローリングに合わせた薄型畳や、モダンな縁なし畳のご相談が増えています。
              </p>
              <p>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                { title: "縁なし畳への変更", desc: "和紙表・樹脂表のカラー畳で新しい住まいの和室を一新。" },
                { title: "和紙畳・樹脂畳への新調", desc: "傷・汚れ・湿気に強く、子育て世帯におすすめ。" },
      ...
      <CTASection
        title="吉川市の畳工事はお気軽にご相談ください"
        subtitle="吉川美南の新築戸建てから賃貸の原状回復まで、吉川市全域で対応。現地確認・お見積もりは無料です。"
      />
    </>
  );
}

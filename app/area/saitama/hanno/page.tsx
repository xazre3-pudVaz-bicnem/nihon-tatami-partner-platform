...
const { pref, city } = getCity("saitama", "hanno") || { pref: null, city: null };

const FAQ_ITEMS = [
  {
    q: "飯能市内のどのエリアまで対応していますか？",
    a: "飯能市全域に対応しています。飯能駅・東飯能駅周辺の市街地から、名栗・原市場・吾野・美杉台など山あいの地域まで、市内全域でご依頼をお受けしています。",
    category: "general" as const,
  },
  {
    q: "山あいの集落や古民家にも来てもらえますか？",
    a: "はい。飯能市は名栗・吾野をはじめ山間部の集落が広がっています。広い和室や囲炉裏のある古民家の畳新調・表替えにも、現地の状況を確認したうえで対応します。",
    category: "general" as const,
  },
  {
    q: "西川材など地元の木材を使った家の畳も頼めますか？",
    a: "はい。飯能は林業が盛んな西川材の産地で、無垢材を活かした住まいが多い地域です。木の風合いに調和するい草畳や、縁の色柄までご相談のうえで仕上げます。",
    category: "general" as const,
  },
  {
    q: "自然が多い地域ですが畳の虫・湿気対策はできますか？",
    a: "はい。山に近い立地では虫の付着や湿気によるカビが気になるという声を多くいただきます。防虫・防カビ加工の畳表や、調湿性に優れた和紙畳・樹脂畳をご提案できます。",
  ...
  },
  {
    ...
    a: "はい。飯能市は自然環境の良さから別荘・セカンドハウスも点在しています。普段留守にされているお宅でも、日程を調整して訪問・施工いたします。",
    category: "general" as const,
  },
  {
    q: "襖や障子もまとめて頼めますか？",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "飯能市", item: `${SITE_URL}/area/saitama/hanno` },
  ],
};
...
const webPageSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  "@id": `${SITE_URL}/area/saitama/hanno#webpage`,
  name: "飯能市の畳張替え・表替え・新調",
  description: "飯能市全域で畳の張替え・表替え・新調に対応。西川材の産地・山あいのまちの古民家・別荘・戸建てに実績豊富。現地確認・見積もり無料。",
  url: `${SITE_URL}/area/saitama/hanno`,
  inLanguage: "ja",
...
const localBusinessSchema = {
  ...
  telephone: SITE_TEL,
  email: SITE_EMAIL,
  description: "飯能市全域対応の畳張替え・表替え・新調・原状回復専門業者。山あいの古民家・別荘の広い和室にも対応。",
...
export default function HannoPage() {
  return (
    <>
      ...
      <section className="bg-sumi py-16 sm:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-sm text-white/60 max-w-2xl leading-relaxed mb-6">
            林業のまちならではの無垢材の住まいに調和するい草畳から、虫・湿気に強い素材まで丁寧にご提案。囲炉裏のある和室や続き間の新調も承ります。
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-sumi/80 leading-relaxed">
              <p>
                飯能市は埼玉県西部、市域の多くを森林が占める自然豊かな山あいのまちです。古くから「西川材」と呼ばれる良質な木材の産地として林業が栄え、入間川の上流に沿って集落が広がってきました。近年はムーミンバレーパークやメッツァビレッジで注目を集めています。
              </p>
              <p>
                住宅は、名栗・吾野・原市場など山間部に広い和室や囲炉裏を備えた古民家・農家住宅が残る一方、飯能駅・東飯能駅周辺や美杉台などの丘陵地には戸建て住宅地も広がります。西川材の無垢材を活かした住まいも多く、木の風合いに調和した畳選びが求められます。
              </p>
              <p>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { title: "山あいの古民家・農家住宅", desc: "囲炉裏のある広い和室や続き間の畳新調・表替えに対応。" },
                { title: "西川材の住まいに調和", desc: "無垢材の風合いに合うい草畳・縁の色柄までご提案。" },
                { title: "虫・湿気対策の素材提案", desc: "山に近い立地に配慮した防虫・防カビ・調湿素材。" },
                { title: "別荘・丘陵地の戸建て", desc: "美杉台などの住宅地や別荘の和室リフレッシュに対応。" },
              ].map((item, i) => (
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                ...
                { title: "い草畳への表替え", desc: "木の家に調和する自然素材の香りと肌ざわり。" },
                { title: "和紙畳・樹脂畳への変更", desc: "虫・湿気・色あせに強く、別荘や山あいの住まいに好適。" },
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  {[
                    ...
                    { label: "畳 表替え（い草）", price: "4,500円〜/枚", note: "木の家に調和する自然素材" },
      ...
      <CTASection
        title="飯能市の畳工事はお気軽にご相談ください"
        subtitle="山あいの古民家から丘陵地の戸建てまで、飯能市全域で対応。現地確認・お見積もりは無料です。"
      />
    </>
  );
}

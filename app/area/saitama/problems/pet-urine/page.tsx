...
export const metadata: Metadata = buildMetadata({
  title: "埼玉でペットによる畳の汚れ・臭いに悩む方へ｜素材変更の選択肢",
  description:
    "埼玉県でペット（猫・犬）の尿による畳の汚れ・臭いにお困りの方へ。染み込んだ尿の応急処置、表替え・新調の判断基準、防水性の高い樹脂畳・和紙畳への素材変更の選択肢を専門家が解説。現地確認・見積もり無料。",
  path: "/area/saitama/problems/pet-urine",
});
...
const faqItems = [
  ...
  },
  {
    category: "general" as const,
    q: "樹脂畳はペットの尿に強いですか？",
    a: "樹脂畳はポリプロピレン製で防水性が高く、ペットの尿をすぐに拭き取れるため、い草畳と比べて大幅に臭い・シミのリスクを抑えられます。ペットを飼っているご家庭に特におすすめです。",
  },
  {
    category: "general" as const,
    q: "和紙畳はペット対応に向いていますか？",
  ...
  {
    category: "general" as const,
    q: "ペットがいる家での畳の選び方を教えてください。",
    a: "防水性の高い樹脂畳が最もペット対応に優れています。和室の風合いを重視する場合は撥水性のある和紙畳がおすすめです。どちらもダニが繁殖しにくく、清掃が簡単なため、ペットのいる家庭に向いています。",
  },
  {
    category: "general" as const,
    q: "ペットによるシミは賃貸の原状回復費用として請求されますか？",
    a: "ペットによる汚損・臭いは借主の故意・過失による損傷とみなされることが多く、原状回復費用（表替え・新調）を求められるケースがあります。状況によって判断が異なりますので、詳しくはご相談ください。",
  },
  {
    category: "general" as const,
  ...
  {
    category: "general" as const,
    q: "複数匹ペットがいますが、費用はどのくらいかかりますか？",
    a: "汚れ・臭いの程度と枚数によって異なります。表替えは4,500円〜/枚、新調は15,000円〜/枚が目安です。素材を樹脂畳や和紙畳に変更する場合は8,000円〜/枚が目安となります。正確な費用は現地確認後にご案内します。",
  },
  {
    category: "general" as const,
    q: "ペット対応の畳に変えた後、何か特別なお手入れが必要ですか？",
    a: "樹脂畳・和紙畳は水拭きができるため、通常の掃除機がけと拭き掃除で清潔に保てます。尿などの汚れはすぐに拭き取ることが基本です。定期的に畳の状態を確認し、気になる点があれば早めにご相談ください。",
  },
];
  ...
  return (
    <>
      ...
      <section className="bg-shiro border-b border-border py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <p className="text-xs tracking-[0.3em] text-kincya mb-4 uppercase">Pet Urine on Tatami — Saitama</p>
          <h1
            className="text-3xl sm:text-4xl leading-snug mb-6 text-sumi"
            style={{ fontFamily: "var(--font-serif)", letterSpacing: "0.06em" }}
          >
            埼玉でペットによる畳の汚れ・臭いに悩んでいる方へ
          </h1>
          <p className="text-sumi/70 text-sm sm:text-base leading-relaxed max-w-2xl">
            猫・犬の尿が畳に染み込んだ場合、時間が経つほど除去が困難になります。応急処置のポイントから、表替え・新調の判断基準、ペットに強い素材への変更まで解説します。
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section>
          ...
          <div className="bg-white border border-border rounded-sm p-6 space-y-4 text-sm text-sumi/80 leading-relaxed">
            <p>
              ペットの尿はい草の多孔質構造に染み込みやすく、時間が経つほど畳床（芯材）へと浸透します。尿に含まれるアンモニア・タンパク質がカビ・ダニの栄養源となり、複合的な問題に発展することがあります。
            </p>
        ...
        <section>
          ...
          <div className="bg-white border border-border rounded-sm p-6 space-y-4 text-sm text-sumi/80 leading-relaxed">
            ...
            <ol className="list-decimal pl-5 space-y-3">
              ...
              <li>
                <strong>乾燥させる：</strong>扇風機・換気で十分に乾燥させます。
              </li>
            </ol>
        ...
        <section>
          <h2
            ...
            style={{ fontFamily: "var(--font-serif)", letterSpacing: "0.05em" }}
          >
            樹脂畳・和紙畳などペット対応素材の選択肢
          </h2>
          <div className="bg-white border border-border rounded-sm p-6 space-y-4 text-sm text-sumi/80 leading-relaxed">
            <p>
              表替え・新調のタイミングでペット対応の素材に変更することで、今後の汚れ・臭いリスクを大幅に下げることができます。
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-shiro rounded-sm p-4">
      ...
      <CTASection
        title="ペットによる畳の汚れ・臭いについてご相談ください"
        subtitle="埼玉県内の現地確認・お見積もりは無料です。表替え・新調・素材変更のどれが最適か、現場を確認してからご案内します。"
      />
    </>
  );
}

...
const breadcrumbSchema = {
  ...
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "埼玉で畳の臭いが気になる方へ", item: `${SITE_URL}/area/saitama/problems/tatami-smell` },
  ],
};
...
const webPageSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  "@id": `${SITE_URL}/area/saitama/problems/tatami-smell#webpage`,
  name: "埼玉で畳の臭いが気になる方へ",
  description:
    "埼玉県で畳の臭い（カビ臭・古畳臭・湿気臭）にお困りの方へ。臭いの原因ごとの対処法、換気でも取れない場合の表替え・新調の判断基準を専門家が解説。ペットの臭いに悩む方にも素材変更の選択肢をご紹介。現地確認・見積もり無料。",
  url: `${SITE_URL}/area/saitama/problems/tatami-smell`,
  inLanguage: "ja",

        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-sumi/80 leading-relaxed">
              ...
              <p>
                埼玉県は不動産投資の活発な地域です。賃貸物件・アパート・マンションの数が首都圏の中でも特に多く、不動産管理会社・賃貸オーナー様からの継続案件が常に多くあります。複数物件の一括発注、現地確認・見積もり・施工のスケジュール調整、施工前後の写真付き報告書の提出など、プロフェッショナルな対応を心がけています。
              </p>
            </div>
          </div>

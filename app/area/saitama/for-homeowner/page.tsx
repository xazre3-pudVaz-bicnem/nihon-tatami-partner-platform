...
export const metadata: Metadata = buildMetadata({
  title: "埼玉の一般住宅向け畳張替え・表替え・新調｜埼玉畳店",
  description:
...
const breadcrumbSchema = {
  ...
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "一般住宅向け畳工事", item: `${SITE_URL}/area/saitama/for-homeowner` },
  ],
};
...
const webPageSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  "@id": `${SITE_URL}/area/saitama/for-homeowner#webpage`,
  name: "埼玉の一般住宅向け畳張替え・表替え・新調",
  description:
    "埼玉県の戸建・マンション和室の畳張替え・表替え・新調に対応。日常使いの畳の傷み・変色・へたりでお困りの方に、適切な施工方法とタイミングをご提案します。",
  url: `${SITE_URL}/area/saitama/for-homeowner`,
  inLanguage: "ja",
        ...
        sections={[
          ...
          },
          {
            ...
            content: (
              <>
                <p>
                  埼玉畳店は、埼玉県内の一般住宅（戸建・マンション）の畳工事を専門に承っています。長年使い込んで変色・へたりが出てきた畳、子どもが走り回って傷んだ畳、湿気で気になる臭いが出てきた畳など、日常使いの中で生じるあらゆる畳の悩みに対応します。
                </p>
                <p>

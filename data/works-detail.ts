...
const SEEDS: Seed[] = [
  // ===== 一般住宅 畳表替え =====
  {
    ...
    result:
      "色あせて白茶けていた和室が、青々とした新しい畳によみがえりました。い草の香りが戻り、ご家族から「部屋に入るたびに気持ちが良い」とのお声をいただきました。リビング続きの和室の印象が一新され、来客時にも自信を持って案内できるようになったとご満足いただけました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "汚れを気にせずお子様を遊ばせられるようになり、ご家族に安心していただけました。色あせに強いため、長くきれいな状態を保てます。「水拭きできるので掃除がぐっと楽になった」とのお声をいただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "法事に間に合い、新しいい草の香りと清潔感のある客間で親族をお迎えできたとご満足いただけました。「直前の相談だったのに間に合わせてもらえて助かった」とのお声をいただきました。",
    staffComment:
  ...
  // ===== 賃貸 退去後原状回復 =====
  {
    ...
    result:
      "色あせた和室が清潔感のある空間に一新され、すぐに募集を開始できました。畳とクロスをまとめて依頼いただいたことで、別々に発注するより短期間で完了。空室期間の短縮につながったと管理会社様にご評価いただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "沈みのあった和室が、新品同様の快適な空間になりました。踏み心地が改善され、次の入居者にも好印象を与えられる状態に。「しっかり直してもらえて安心して募集できる」とオーナー様にご満足いただけました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・面積により変動（現地確認後にご案内）",
    result:
      "畳・襖・障子がすべて新しくなり、和室2部屋が見違えるように清潔になりました。一社にまとめたことで管理会社様の手間が減り、工期も短縮。スムーズに次の募集に移れたとご評価いただきました。",
    staffComment:
  ...
  // ===== 旅館 =====
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "全客室の畳が新しくなり、青々としたい草の香りでお客様をお迎えできる状態になりました。繁忙期前に間に合い、宿泊客の満足度向上につながったと女将様にご評価いただきました。営業を止めずに完了できた点もご好評でした。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "沈みのあった大広間が、しっかりとした踏み心地と格式ある見た目に一新されました。大人数の宴会でも安心して使える状態になり、施設の価値向上につながったとご評価いただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "客室が現代的で洗練された印象に生まれ変わり、若い世代やインバウンドのお客様からも好評を得られたとのことです。色あせに強い和紙畳のため、メンテナンスの負担も軽減されました。",
    staffComment:
  ...
  // ===== 寺院 =====
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "本堂が格式ある清潔な空間に一新され、法要を滞りなく執り行えたとご住職にご評価いただきました。伝統に配慮した縁の選定にもご満足いただき、参拝者からも好印象を得られたとのことです。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "客殿・控室が清潔感のある空間に一新され、来客を気持ちよくお迎えできるようになったとご評価いただきました。複数室をまとめて施工したことで効率的に完了できました。",
    staffComment:
  ...
  // ===== 神社 =====
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "社務所・参集殿が清潔な空間に整い、参拝者や祭事の場として気持ちよく利用できるようになったとご評価いただきました。祭事に支障なく施工できた点もご好評でした。",
    staffComment:
  ...
  // ===== 店舗（和食店） =====
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "飲み物をこぼしても水拭きで簡単に対処でき、日々の清掃が楽になったと店主様にご好評。汚れに強いため、座敷を常に清潔に保てるようになりました。お客様の満足度向上にもつながったとのことです。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "個室が和モダンで特別感のある空間に生まれ変わり、お客様から好評を得られたとのことです。色あせに強い和紙畳のため、清潔感を長く保てます。他店との差別化につながったとご評価いただきました。",
    staffComment:
  ...
  // ===== 襖張替え =====
  {
    ...
    result:
      "日焼けと破れで傷んでいた襖が一新され、和室が明るく整いました。「相談しながら柄を選べて満足」とのお声をいただきました。畳・障子との調和もとれた、まとまりのある和室になりました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・グレードにより変動（現地確認後にご案内）",
    result:
      "汚れていた襖がすべて新しくなり、清潔感のある和室になりました。畳・クロスの工事と合わせてご依頼いただいたことで、効率よく原状回復が完了。スムーズに募集を開始できたとご評価いただきました。",
    staffComment:
  ...
  // ===== 障子張替え =====
  {
    ...
    result:
      "破れと黄ばみで傷んでいた障子が一新され、和室が明るくなりました。強化紙のため、お孫さんが来ても破れにくく安心とご好評。「丈夫で長持ちしそう」とご満足いただけました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数により変動（現地確認後にご案内）",
    result:
      "ペットが飛びついても破れにくくなり、たびたびの張替えから解放されたとご好評。水拭きできるため、お手入れも楽になりました。「もっと早く替えればよかった」とのお声をいただきました。",
    staffComment:
  ...
  // ===== 賃貸マンション 原状回復 =====
  {
    ...
    result:
      "和室一式が清潔に整い、すぐに募集を再開できました。まとめて依頼いただいたことで、別々に発注するより短期間・効率的に完了。空室期間の短縮につながったとご評価いただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "面積・枚数により変動（現地確認後にご案内）",
    result:
      "ペット可物件として募集できるようになり、入居者層が広がりました。傷・汚れに強い仕様のため、長期的な維持管理もしやすくなりました。空室対策として効果的だったとオーナー様にご評価いただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "面積・枚数により変動（現地確認後にご案内）",
    result:
      "ヤニ汚れと臭いが解消され、清潔な空間に再生できました。消臭クロスの採用で臭い戻りも抑えられ、次の入居者を気持ちよく迎えられる状態に。スムーズな募集再開につながったとご評価いただきました。",
    staffComment:
  ...
  // ===== オフィス 原状回復 =====
  {
    ...
    result:
      "契約上の回復範囲を満たし、退去期限内に原状回復を完了できました。期限が厳しい中でも計画的に進められ、スムーズな退去につながったとご評価いただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "面積・枚数により変動（現地確認後にご案内）",
    result:
      "和室応接室が清潔に整い、原状回復を完了できました。畳と内装をまとめて依頼いただいたことで、効率的に進められたとご評価いただきました。",
    staffComment:
  ...
  // ===== 店舗内装 =====
  {
    ...
    result:
      "店舗が和の趣あふれる上質な空間に生まれ変わり、お客様から好評を得られたとのことです。畳から内装まで一社で対応したことで、統一感のある仕上がりになりました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "規模により変動（現地確認後にご案内）",
    result:
      "くつろげる小上がりの畳コーナーが新設され、客席のバリエーションが増えました。お客様に好評で、店舗の魅力向上につながったとご評価いただきました。",
    staffComment:
  ...
  // ===== 空室対策リノベーション =====
  {
    ...
    cost: "面積・枚数により変動（現地確認後にご案内）",
    result:
      "ありきたりだった和室が、モダンで魅力的な空間に生まれ変わりました。内見からの反応が良くなり、空室解消につながったとオーナー様にご評価いただきました。差別化の効果を実感いただけました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "面積により変動（現地確認後にご案内）",
    result:
      "和室が使い勝手の良い洋室に生まれ変わり、入居者層が広がりました。内見の反応が改善し、空室解消につながったとご評価いただきました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "面積・枚数により変動（現地確認後にご案内）",
    result:
      "戸建全体が明るく清潔に生まれ変わり、再募集での反応が改善しました。まとめて一社に依頼いただいたことで、効率的に短期間で完了。空室解消につながったとご評価いただきました。",
    staffComment:
  ...
  // ===== 分譲マンション =====
  {
    ...
    cost: "面積・枚数により変動（現地確認後にご案内）",
    result:
      "ペットと暮らしやすい、清潔で長持ちする住まいに仕上がりました。和紙畳とフロアタイルの組み合わせで、傷・汚れを気にせず過ごせるようになったとご満足いただけました。",
    staffComment:
  ...
  },
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "リビングに馴染むモダンな畳コーナーが完成し、家族のくつろぎスペースになりました。フローリングとの調和もとれ、「リビングが上質になった」とご満足いただけました。",
    staffComment:
  ...
  // ===== 縁なし畳新調 =====
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "新築の家全体のテイストに調和した、モダンで洗練された和室が完成しました。「想像以上におしゃれな仕上がり」とご満足いただけました。色あせに強い素材で、長く美しさを保てます。",
    staffComment:
  ...
  // ===== 和紙畳 =====
  {
    ...
    cost: "枚数・素材により変動（現地確認後にご案内）",
    result:
      "沈みが解消されてつまずきの心配がなくなり、安全な和室になりました。和紙畳のため掃除も楽になり、お手入れの負担が軽減。高齢のご家族にも安心してお使いいただけるとご満足いただけました。",
    staffComment:
